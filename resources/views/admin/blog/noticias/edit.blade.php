...
@section('contenido_body')
	...
	{!! Form::model($post, ['route' => ['admin.blog.noticias.update', $post->id], 'method' => 'PUT', 'files' => 'true', 'class' => 'row']) !!}
	<div class="col-md-9">
		<!--begin::Portlet-->
			...
			<div class="m-form m-form--fit m-form--label-align-right">
				<div class="m-portlet__body">
					...
					<div class="form-group m-form__group">
						...
						{!! Form::select('tags', $tags, $post->tags , ['name' => 'tags[]', 'class' => 'form-control m-select2 select-tag', 'multiple']) !!}
					</div>
				</div>
			</div>
			<!--end::Form-->
			...
			<div class="m-form m-form--fit m-form--label-align-right">
				...
				<div class="m-portlet__body">
					...
					<div class="form-group m-form__group">
						...
						{!! Form::select('categoria', ['' => ''] + $categorias, $post->blog_categoria_id, ['class' => 'form-control m-select2 select-categoria']) !!}
					</div>
					...
					<div class="form-group m-form__group">
						...
						<div class='input-group date input-datetimepicker'>
							{!! Form::text('published_at', $post->fecha_publicacion, ['class' => 'form-control m-input', 'readonly']) !!}
