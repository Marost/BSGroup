...
@section('contenido_body')
	...
	{!! Form::open(['route' => 'admin.usuarios.store', 'method' => 'POST', 'class' => 'row']) !!}
		<div class="col-md-9">
			<!--begin::Portlet-->
				...
				<div class="m-form m-form--fit m-form--label-align-right">
					<div class="m-portlet__body">
						<div class="form-group m-form__group">
							<label>Nombres</label>
							{!! Form::text('nombres', null, ['class' => 'form-control m-input']) !!}
						</div>
						<div class="form-group m-form__group">
							<label>Apellidos</label>
							{!! Form::text('apellidos', null, ['class' => 'form-control m-input']) !!}
						</div>
						<div class="form-group m-form__group">
							<label>Email</label>
