...
@section('contenido_body')
	...
	{!! Form::model($post, ['route' => ['admin.configuracion.url.items.update', $url, $post->id], 'method' => 'PUT', 'files' => 'true', 'class' => 'row']) !!}
	<div class="col-md-9">
		<!--begin::Portlet-->
				...
				<div class="m-portlet__body">
					@if($url == 'redes-sociales')
						<div class="form-group m-form__group">
							...
							{!! Form::select('red', ['' => ''] + $iconsRedes, $post->icono_id, ['class' => 'form-control m-select2 select-redsocial']) !!}
						</div>

						<div class="form-group m-form__group">
							<label>Enlace</label>
							{!! Form::text('enlace', $post->enlace, ['class' => 'form-control m-input']) !!}
						</div>
					@else
						<div class="form-group m-form__group">
							<label>Titulo</label>
