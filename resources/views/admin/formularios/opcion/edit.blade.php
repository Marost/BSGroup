...
@php
	switch ($url){
		case 'contacto': $titulo = 'Contacto'; break;
	}
@endphp
...
@section('contenido_body')
	...
	{!! Form::open(['route' => ['admin.formularios.opcion.update', $url], 'method' => 'PUT', 'files' => 'true', 'class' => 'row']) !!}
	<div class="col-md-9">
		<!--begin::Portlet-->
					...
					@foreach($post as $item)
						<div class="form-group m-form__group">
							...
							@if($item->input == 'textarea')
								{!! Form::label($item->etiqueta) !!}
								{!! Form::textarea('valor['.$item->nombre.']', $item->valor, ['id' => 'contenido','class' => 'form-control', 'rows' => '4']) !!}
							@endif
							@if($item->nombre == 'email')
								<span class="m--font-bolder m--font-transform-u">
									Si desea que los mensajes se envíe a más correos, separelos por comas(,)
								</span>
							@endif
						</div>
					@endforeach
